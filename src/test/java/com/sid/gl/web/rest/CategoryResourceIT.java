...
import com.sid.gl.domain.Category;
import com.sid.gl.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().categoryName(DEFAULT_CATEGORY_NAME).description(DEFAULT_DESCRIPTION);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION);
