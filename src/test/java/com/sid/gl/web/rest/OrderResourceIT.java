...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().quantityOrder(DEFAULT_QUANTITY_ORDER).date(DEFAULT_DATE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().quantityOrder(UPDATED_QUANTITY_ORDER).date(UPDATED_DATE);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getQuantityOrder()).isEqualTo(DEFAULT_QUANTITY_ORDER);
    ...
    @Test
    @Transactional
    void checkQuantityOrderIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setQuantityOrder(null);
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.quantityOrder(UPDATED_QUANTITY_ORDER).date(UPDATED_DATE);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getQuantityOrder()).isEqualTo(UPDATED_QUANTITY_ORDER);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantityOrder(UPDATED_QUANTITY_ORDER);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantityOrder(UPDATED_QUANTITY_ORDER).date(UPDATED_DATE);
