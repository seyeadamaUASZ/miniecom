...
describe('Product e2e test', () => {
  ...
  const productSample = { productName: 'Personal b invoice', quantity: 92142, unitprice: 71618 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="quantity"]`).type('57804').should('have.value', '57804');

      cy.setFieldImageAsBytesOfEntity('imageProduct', 'integration-test.png', 'image/png');

      cy.get(`[data-cy="unitprice"]`).type('55601').should('have.value', '55601');

      cy.get(`[data-cy="status"]`).select('EMPTY');
