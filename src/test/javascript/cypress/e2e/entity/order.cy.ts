...
describe('Order e2e test', () => {
  ...
  const orderSample = { quantityOrder: 58821, date: '2023-05-06T04:00:38.155Z' };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="quantityOrder"]`).type('92925').should('have.value', '92925');

      cy.get(`[data-cy="date"]`).type('2023-05-06T20:43').blur().should('have.value', '2023-05-06T20:43');
